...
void handleJoystick() {
  ...
  if (yValue < 300 && direction != 2) direction = 0; // UP
  if (yValue > 700 && direction != 0) direction = 2; // DOWN
  if (xValue > 700 && direction != 3) direction = 1; // RIGHT
  if (xValue < 300 && direction != 1) direction = 3; // LEFT
}
